...
import co.edu.unal.tictactoe.Objetos.BoardModel;
import co.edu.unal.tictactoe.Objetos.FirebaseReferences;
import co.edu.unal.tictactoe.Objetos.TicTacToeModel;
...
public class AndroidTicTacToeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference myref = database.getReference(FirebaseReferences.REFERENCE);
        myref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                BoardModel data = dataSnapshot.getValue(BoardModel.class);
                Log.d("BoardModel: " ,dataSnapshot.toString());
            }
